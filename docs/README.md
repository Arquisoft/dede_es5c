...
la url en la que se despliega es: [https://arquisoft.github.io/dede_es5c/](https://arquisoft.github.io/dede_es5c/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/dede_es5c/](https://arquisoft.github.io/dede_es5c/) necesitamos ejecutar `npm run deploy`.
